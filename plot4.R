...
par(mfrow=c(2,2))
with(my_data, {
   plot(DTTM,Global_active_power,type="l",xlab="",ylab="Global Active Power")
   plot(DTTM,Voltage,type="l",xlab="datetime")
   plot(DTTM,Sub_metering_1,type="l",col="Black",xlab="",ylab="Energy Sub Metering")
   points(DTTM,Sub_metering_2,type="l",col="Red")
   points(DTTM,Sub_metering_3,type="l",col="Blue")
   legend("topright",pch="-",lwd=4,col=c("black","red","blue"),legend=c("Sub_metering_1","Sub_metering_2","Sub_metering_3"))
   plot(DTTM,Global_reactive_power,type="l",xlab="datetime")
})
